...
//
// The surface / swapchain / present / wait set are the eight mandatory Vulkan
// hooks SL declares in streamline/include/sl_hooks.h. They must be installed
// together: mixing some entries through SL and some through static-link
// desyncs SL's internal swapchain->device->instance map and crashes Reflex's
// swapchain-bound entries. (The PFN_vk* typedefs come from <vulkan/vulkan.h>
// via the internal/VulkanCommon.h include above.)
